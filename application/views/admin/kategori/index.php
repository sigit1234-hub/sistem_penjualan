                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    <label for="nameLarge" class="form-label">Kode</label>
                                    <input type="text" id="kode" name="kode" class="form-control" value="<?= $ed['kode']; ?>" />
                                    <?= form_error('kode', '<small class="text-danger pl-3">', '</small>') ?>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="emailLarge" class="form-label">Aktif</label>
