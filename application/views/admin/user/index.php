                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="dobLarge" class="form-label">Foto</label>
                                <input type="file" id="foto" name="foto" class="dropify" data-default-file="<?= base_url('assets/img/user/' . $ed['foto']) ?>" value="<?= base_url('assets/img/user/' . $ed['foto']) ?>">
