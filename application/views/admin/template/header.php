...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('vendor/admin/') ?>assets/vendor/libs/apex-charts/apex-charts.css" />
    <!-- buat custom box uploadnya  -->
    <link rel="stylesheet" href="<?= base_url('assets/') ?>custombox/css/custombox.min.css">
    <!-- file upload  -->
    <link rel="stylesheet" href="<?= base_url('assets/fileuploads/') ?>css/dropify.min.css">
    <!-- Page CSS -->
