    ...
    <script>
        function autoPrintAndRedirect() {
            ...
            window.onafterprint = function() {
                ...
                window.location.href = '<?= base_url('Kasir/penjualan') ?>';
            };
        }
...
<body class="struk">
    <section class="sheet">
        ...
        <div class="kasir">
            <table>
                ...
                <tr>
                    ...
                    <td align="left" class="txt-left">:</td>
                    <td align="left" class="txt-left">&nbsp; <?= nama($this->session->userdata('id')) ?></td>
                </tr>
                <tr>
                    <td align="left" class="txt-left">Pembeli&nbsp;</td>
                    <td align="left" class="txt-left">:</td>
                    <td align="left" class="txt-left">&nbsp; <?= $user ?></td>
                </tr>
                <tr>
        ...
        <table class="table table-light">
            ...
            <tbody>
                <?php foreach ($dataTransaksi->result_array() as $d)  ?>
                <?php
