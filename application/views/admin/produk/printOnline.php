    ...
    <section class="sheet">
        ...
        <table class="table table-light">
            ...
            <tbody>
                ...
                <tr>
                    <td align="left" width="70%" class="txt-left">Sub Total&nbsp;</td>
                    <td></td>
                    <td></td>
                    <td align="right" width="30%" class="txt-left"> <?= Rupiah($d['total_pembayaran']); ?></td>
                </tr>
            </tbody>
        </table>
        <?= str_repeat("-", 40) . "<br/>"; ?>
        <div class="total">
            <table width="100%">
                <tr>
                    <td align="left" width="70%" class="txt-left">Metode Pembayaran&nbsp;</td>
                    <td align="right" width="30%"> <?= $d['tipe_pembayaran']; ?></td>
                </tr>
                <tr>
                    <td align="left" width="70%" class="txt-left">Bank&nbsp;</td>
                    <td align="right" width="30%"> <?= $d['bank'] . " " . $d['va_number']; ?></td>
                </tr>
                <tr>
                    <td align="left" width="70%" class="txt-left">Pengiriman&nbsp;</td>
                    <td align="right" width="30%" class="txt-left"> <?= $d['kurir']; ?></td>
                </tr>
                <tr>
                    <td align="left" width="70%" class="txt-left">Paket&nbsp;</td>
                    <td align="right" width="30%" class="txt-left"> <?= $d['paket']; ?></td>
                </tr>
            </table>
        </div>
        <div class="alamat">
