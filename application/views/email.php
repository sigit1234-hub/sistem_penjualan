                            ...
                            <tr>
                                <td style="padding: 0 2.5em; text-align: left;">
                                    <div class="text">
                                        ...
                                        <p>Berikut daftar produk-produk dengan stok dibawah 10 per tanggal : <?php echo tanggal() ?></p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                            <td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
                                <div class="product-entry">
                                    <img src="https://penjualan.my.id/assets/img/produk/" alt="" style="width: 100px; max-width: 600px; height: auto; margin-bottom: 20px; display: block;">
                                    <div class="text">
                                        ...
                                        <tr>
                                            <td style="text-align: left; padding-left: 10px;">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="https://penjualan.my.id/">Belanja</a></li>
