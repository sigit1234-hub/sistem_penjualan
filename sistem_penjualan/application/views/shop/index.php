        ...
        <div class="product__discount">
            ...
            <div class="row">
                <div class="product__discount__slider owl-carousel">
                    <?php foreach ($dataDiskon as $d) : ?>
                        <div class="col-lg-4">
                            <div class="product__discount__item">
                                <div class="product__discount__item__pic set-bg" data-setbg="<?= base_url('assets/img/produk/') . gambar($d['kode_produk']) ?>">
                                    <div class="product__discount__percent">-20%</div>
                                    <ul class="product__item__pic__hover">
                                        <li>
                                            <a href="<?= base_url('Belanja/detailProduk/') . $d['id_produk'] ?>"><i class="fa fa-eye"></i></a>
                                        </li>
                                        <li>
                                            <a href="<?= base_url('Belanja/beli/') . $d['id_produk'] ?>"><i class="fa fa-money"></i></a>
                                        </li>
                                        <li>
                                            <a data-toggle="modal" data-target="#staticBackdrop<?= $d['id_produk'] ?>"><i class="fa fa-shopping-cart"></i></a>
                                        </li>
                                    </ul>
                                </div>
