    ...
    <div class="container">
        ...
        <div class="signup-content">
            <div class="signup-form">
                ...
                <form method="POST" class="register-form" action="<?= base_url('Akun/registrasi') ?>" id="register-form">
            ...
            <div class="signup-image">
                ...
                <a href="<?= base_url('Akun') ?>" class="signup-image-link">Saya sudah punya akun</a>
            </div>
        </div>
    </div>
    <!-- JS -->
