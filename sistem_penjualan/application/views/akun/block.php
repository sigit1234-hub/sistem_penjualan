...
<head>
    ...
    <meta name="sistem penjualan" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?= base_url('vendor/admin/') ?>assets/img/favicon/favicon.ico" />
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="<?= base_url('vendor/admin/') ?>/assets/vendor/css/core.css"
        class="template-customizer-core-css" />
    <link rel="stylesheet" href="<?= base_url('vendor/admin/') ?>/assets/vendor/css/theme-default.css"
        class="template-customizer-theme-css" />
    <link rel="stylesheet" href="<?= base_url('vendor/admin/') ?>/assets/css/demo.css" />

    <!-- Vendors CSS -->
    <link rel="stylesheet"
        href="<?= base_url('vendor/admin/') ?>/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />

    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= base_url('vendor/admin/') ?>/assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <p class="mb-4 mx-2">Anda tidak mempunyai akses untuk ke halaman ini</p>
            <a href="javascript:void(0);" onclick="goBack()" class="btn btn-primary">Back to home</a>
            <div class="mt-3">
                <img src="<?= base_url('vendor/admin/') ?>assets/img/illustrations/page-misc-error-light.png"
