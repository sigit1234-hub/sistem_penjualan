                ...
                <div class="blog__sidebar">
                    <div class="blog__sidebar__item">
                        ...
                        <ul class="nav nav-tabs flex-column mt-5" role="tablist">
                            <li class="nav-item">
                                <button type="button" class="nav-link active btn-block text-left" role="tab" data-bs-toggle="tab" data-bs-target="#navs-home" aria-controls="navs-home" aria-selected="true">
                                    <i class="tf-icons bx bx-home"></i> Profile
                                </button>
                            </li>
                            <li class="nav-item">
                                <button type="button" class="nav-link btn-block text-left" role="tab" data-bs-toggle="tab" data-bs-target="#navs-profile" aria-controls="navs-profile" aria-selected="false">
